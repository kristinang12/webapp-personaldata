...
<header id="header">
  <div class="d-flex flex-column">
    ...
    <div class="profile">
      ...
      <h1 class="text-light"><a href="homepage">Kristine Alcober</a></h1>
    ...
    <nav id="navbar" class="nav-menu navbar">
      <ul>
        ...
        <li><a href="/login" class="nav-link scrollto"><i class="bx bx-log-in btn btn-info"></i> <span>Login</span></a></li>
      </ul>
    </nav><!-- .nav-menu -->
  </div>
</header><!-- End Header -->
